...
public class MaventoANTPane extends JPanel {
    ...
    protected JComponent makeTestFolderPanel(String text, final JTabbedPane tabbedPane) {
        ...
        navigateTabNext(panel,tabbedPane,3,"Next","Test_Folder",testFolderPath);    
       ...
       // nextButton.
        ...
        subButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		antResources.put("lib_folder", libFolderPath.getText());
    ...
    protected JComponent makeSourceFolderPanel(String text, final JTabbedPane tabbedPane) {
        ...
        navigateTabNext(panel,tabbedPane,2,"Next","Source_Folder",sourceFolderPath);       
       ...
       // filler.setVerticalAlignment(JLabel.TOP);
        ...
        browseButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                antResources.put("project_folder", fileName);
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = MaventoANTPane.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        frame.add(new MaventoANTPane(), BorderLayout.CENTER);
